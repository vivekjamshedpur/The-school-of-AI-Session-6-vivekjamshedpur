...
print("Write a normal function without using lambda, zip, and map function to create 52 cards in a deck")
def Deck(list1, list2):
  '''This is a normal function without using lambda, zip, and map function to create 52 cards in a deck'''
